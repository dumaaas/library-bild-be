    ...
    <div class="w-[80%]">
            ...
            <div class="w-full mt-[10px] ml-2 px-4">
                <table class="w-full shadow-lg" id="myTable">
                    ...
                    <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                        ...
                        <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">{{$iznajmljivanjeVracena->return_date}}</td>
                        <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">
                            <div>
                                <span>{{ \Carbon\Carbon::parse($iznajmljivanjeVracena->rent_date)->diffAsCarbonInterval($iznajmljivanjeVracena->return_date) }}</span>
                            </div>
                        </td>
        ...
        @else
            <div class="mx-[40px] flex items-center px-6 py-4 my-4 text-lg bg-red-200 rounded-lg">
                ...
                <p class="font-medium text-red-600"> Knjiga {{$knjiga->title}} nema vracenih primjeraka! </p>
            </div>
        @endif
    </div>
@endsection
