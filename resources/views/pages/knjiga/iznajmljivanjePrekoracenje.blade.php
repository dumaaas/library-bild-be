...
@section('prekoracenjeIznajmljivanje')
    <div class="w-[80%]">
        ...
        <!-- Space for content -->
        @if(count($iznajmljivanjePrekoracene))
            <div class="w-full mt-[10px] ml-2 px-4">
                <table class="w-full shadow-lg" id="myTable">
                    ...
                    <tr class="border-b-[1px] border-[#e4dfdf]">
                        ...
                        <th class="relative p-4 text-sm leading-4 tracking-wider text-left cursor-pointer whitespace-nowrap">Datum izdavanja<i class="ml-2 fas fa-filter datumDrop-toggle"></i>
                        ...
                        <th class="relative p-4 text-sm leading-4 tracking-wider text-left cursor-pointer whitespace-nowrap">Izdato učeniku<i class="fas fa-filter uceniciDrop-toggle"></i>
                    ...
                    @foreach($iznajmljivanjePrekoracene as $iznajmljivanjePrekoracena)
                    <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                        ...
                        <td class="p-4 text-sm leading-5 truncate max-w-[100px]">{{$iznajmljivanjePrekoracena->rent_date}}</td>
                        <td class="p-4 text-sm leading-5 truncate max-w-[100px]">{{$iznajmljivanjePrekoracena->student->name}}</td>
                        <td class="p-4 text-sm leading-5 truncate max-w-[180px]">
                            <div
                                class="inline-block px-[6px] py-[2px] font-medium bg-red-200 rounded-[10px]">
                                <span class="text-xs text-red-800">
                                    {{ \Carbon\Carbon::parse($iznajmljivanjePrekoracena->return_date)->diffInDays(\Carbon\Carbon::now()) }} dan/a
                                </span>
                            </div>
                        </td>
                        <td class="p-4 text-sm leading-5 truncate max-w-[180px]">
                            <div>
                                <span>{{ \Carbon\Carbon::parse($iznajmljivanjePrekoracena->rent_date)->diffAsCarbonInterval() }}</span>
                            </div>
                        </td>
                        <td class="p-4 text-sm leading-5 text-right whitespace-nowrap">
                            ...
                            <div
                                ...
                                <div class="absolute right-0 w-56 mt-2 origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                    ...
                                    <div class="py-1">
                                        <a href="{{route('izdavanjeDetalji',['knjiga'=>$iznajmljivanjePrekoracena->book,'ucenik'=>$iznajmljivanjePrekoracena->student])}}" tabindex="0"
                                        ...
                                        <a href="{{route('izdajKnjigu',['knjiga'=>$iznajmljivanjePrekoracena->book])}}" tabindex="0"
                                        class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                        role="menuitem">
                                        ...
                                        <a href="{{route('vratiKnjigu',['knjiga'=>$iznajmljivanjePrekoracena->book])}}" tabindex="0"
                                        class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                        role="menuitem">
                                        ...
                                        <a href="{{route('rezervisiKnjigu',['knjiga'=>$iznajmljivanjePrekoracena->book])}}" tabindex="0"
                                        class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                        role="menuitem">
                                        ...
                                        <a href="{{route('otpisiKnjigu',['knjiga'=>$iznajmljivanjePrekoracena->book])}}" tabindex="0"
                                        class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                        role="menuitem">
                                        ...
                                        <!-- <a href="{{route('izbrisiKnjigu',['knjiga'=>$iznajmljivanjePrekoracena->book])}}" tabindex="0"
                                        class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                        role="menuitem">
                ...
                {{$iznajmljivanjePrekoracene->links()}}
            </div>
        @else
            <div class="mx-[40px] flex items-center px-6 py-4 my-4 text-lg bg-red-200 rounded-lg">
                ...
                <p class="font-medium text-red-600"> Knjiga {{$knjiga->title}} nema primjeraka u prekoračenju! </p>
            </div>
        @endif
    </div>
@endsection
