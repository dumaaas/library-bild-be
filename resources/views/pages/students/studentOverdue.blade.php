                        ...
                        <table class="w-full shadow-lg" id="myTable">
                            ...
                            @foreach($overdueBooks as $overdueBook)
                                <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                                    ...
                                    <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">{{$overdueBook->rent_date}}</td>
                                        ...
                                        <div
                                            ...
                                            <div class="absolute right-0 w-56 mt-2 origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                                ...
                                                <div class="py-1">
                                                    ...
                                                    <a href="{{route('izdajKnjigu', ['knjiga' => $overdueBook->book])}}" tabindex="0"
                                                        class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                        role="menuitem">
                                                    ...
                                                    <a href="{{route('rezervisiKnjigu', ['knjiga' => $overdueBook->book])}}" tabindex="0"
                                                        class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                        role="menuitem">
                                                    ...
                                                    <a href="{{route('vratiKnjigu', ['knjiga' => $overdueBook->book])}}" tabindex="0"
                                                        class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                        role="menuitem">
                                                    ...
                                                    <a href="{{route('otpisiKnjigu', ['knjiga' => $overdueBook->book])}}" tabindex="0"
                                                        class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                        role="menuitem">
