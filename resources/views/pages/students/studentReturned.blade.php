...
<section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
            ...
            <!-- Space for content -->
            <div class="flex justify-start pt-3 bg-white height-studentRented scroll">
                <div class="mt-[10px]">
                        ...
                        <table class="w-full shadow-lg" id="myTable">
                            ...
                            @foreach($returnedBooks as $returnedBook)
                                <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                                    ...
                                    <td class="p-4 text-sm leading-5 whitespace-nowrap">{{$returnedBook->rent_date}}</td>
                                    <td class="p-4 text-sm leading-5 whitespace-nowrap">{{$returnedBook->rentStatus[0]->date}}</td>
                                    ...
                                    <td class="p-4 text-sm leading-5 whitespace-nowrap">{{$returnedBook->librarian->name}}</td>
