                        ...
                        <table class="w-full shadow-lg" id="myTable">
                            <thead class="bg-[#EFF3F6]">
                                <tr class="border-b-[1px] border-[#e4dfdf]">
                                    ...
                                    <th class="flex items-center p-2 text-xs leading-4 tracking-wider text-left xl:p-3 2xl:p-4 whitespace-nowrap 2xl:text-sm">Naziv
                            ...
                            @foreach($archivedReservations as $archivedReservation)
                                <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                                    ...
                                    <td class="p-2 text-xs leading-5 2xl:text-sm xl:p-3 2xl:p-4 whitespace-nowrap">{{$archivedReservation->reservation_date}}</td>
                                    <td class="p-2 text-xs leading-5 2xl:text-sm xl:p-3 2xl:p-4 whitespace-nowrap">{{$archivedReservation->reservation_date->addDays(20)}}</td>
                                    <td class="flex flex-row items-center p-2 xl:p-3 2xl:p-4 whitespace-nowrap">
                                    ...
                                    <td class="p-2 text-xs leading-5 text-blue-900 2xl:text-sm xl:p-3 2xl:p-4 whitespace-nowrap">
                                    ...
                                    <td class="p-2 text-xs leading-5 text-right 2xl:text-sm xl:p-3 2xl:p-4">
                                        <p
                                            class="inline cursor-pointer text-[20px] py-[10px] px-[10px] xl:px-[20px] 2xl:px-[30px] border-gray-300 dotsStudentArchivedBooks hover:text-[#606FC7]">
                                            <i class="fas fa-ellipsis-v"></i>
                                        </p>
                                        <div
