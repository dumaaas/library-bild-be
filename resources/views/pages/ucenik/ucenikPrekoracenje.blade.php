            ...
            <div class="flex justify-start pt-3 bg-white height-ucenikIzdate scroll">
                                    ...
                                    <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">
                                        <div class="inline-block px-[6px] py-[2px] font-medium bg-red-200 rounded-[10px]">
                                            <span class="text-xs text-red-800">
                                                {{ \Carbon\Carbon::parse($ucenikPrekoracena->return_date)->diffInDays(\Carbon\Carbon::now()) }} days
                                            </span>
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">
                ...
                @else
                    <div class="mx-[40px] h-[60px] flex items-center px-6 py-4 my-4 text-lg bg-red-200 rounded-lg">
                        ...
                        <p class="font-medium text-red-600"> Ucenik {{$user->name}} nema primjeraka u prekoracenju! </p>
                    </div>
                @endif
            </div>
        </section>
