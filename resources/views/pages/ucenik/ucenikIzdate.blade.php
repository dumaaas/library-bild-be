            ...
            <div class="flex justify-start pt-3 bg-white height-ucenikIzdate scroll">
                            ...
                            <div class="w-[300px] pl-[32px]">
                                <span class=" whitespace-nowrap w-full text-[25px] flex justify-between fill-current">
                                    <div
                                        ...
                                        <a href="{{route('ucenikVracene', ['user' => $user])}}" aria-label="Izdate knjige"
                ...
                @if(count($ucenikIzdate) > 0)
                    <div class="w-full mt-[10px] ml-2 px-2">
                        <table class="w-full shadow-lg" id="myTable">
                            ...
                            @foreach($ucenikIzdate as $ucenikIzdata)
                                <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                                    ...
                                    <td class="flex flex-row items-center px-4 py-3">
                                        @if(count($ucenikIzdata->book->coverImage) > 0 )
                                            <img class="object-cover w-8 mr-2 h-11" src="/storage/image/{{$ucenikIzdata->book->coverImage[0]->photo}}" alt="" />
                                        @endif
                                        <a href="{{route('izdavanjeDetalji', ['knjiga' => $ucenikIzdata->book, 'ucenik' => $ucenikIzdata->student])}}">
                                            <span class="font-medium text-center">{{$ucenikIzdata->book->title}}</span>
                                        </a>
                                    </td>
                                    <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">{{$ucenikIzdata->rent_date}}</td>
                                    <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">
                                        <div>
                                            <span>{{ \Carbon\Carbon::parse($ucenikIzdata->rent_date)->diffAsCarbonInterval() }}</span>
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">{{$ucenikIzdata->librarian->name}}</td>
                                    <td class="px-6 py-3 text-sm leading-5 text-right whitespace-no-wrap">
                                        ...
                                        <div
                                            ...
                                            <div class="absolute right-0 w-56 mt-2 origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                                ...
                                                role="menu">
                                                <div class="py-1">
                                                    <a href="{{route('izdavanjeDetalji', ['knjiga' => $ucenikIzdata->book, 'ucenik' => $ucenikIzdata->student])}}" tabindex="0"
                                                        class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                        role="menuitem">
                                                    ...
                                                    <a href="{{route('vratiKnjigu', ['knjiga' => $ucenikIzdata->book])}}" tabindex="0"
                                                        class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                        role="menuitem">
                                                    ...
                                                    <a href="{{route('otpisiKnjigu', ['knjiga' => $ucenikIzdata->book])}}" tabindex="0"
                                                        class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                        role="menuitem">
                ...
                @else
                    <div class="mx-[40px] h-[60px] flex items-center px-6 py-4 my-4 text-lg bg-red-200 rounded-lg">
                        ...
                        <p class="font-medium text-red-600"> Ucenik {{$user->name}} nema izdatih primjeraka! </p>
                    </div>
                @endif
            </div>
        </section>
