...
@section('editPovez')
    @can('isAdmin')
                    ...
                    <div>
                        <nav class="w-full rounded">
                            <ol class="flex list-reset">
                                ...
                                <li>
                                    <a href="{{route('settingsPovez')}}" class="text-[#2196f3] hover:text-blue-600">
                                        Povezi
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="{{route('editPovez', ['povez' => $povez->id])}}" class="text-gray-400 hover:text-blue-600">
                                        Izmijeni podatke
                                    </a>
                                </li>
                            </ol>
        ...
        <div class="scroll height-content section-content">
            <form action="{{route('izmijeniPovez', ['povez' => $povez->id])}}" method="POST" class="text-gray-700 forma">
                @csrf
                <div class="flex flex-row ml-[30px]">
                    <div class="w-[50%] mb-[150px]">
                        <div class="mt-[20px]">
                            <p>Naziv poveza <span class="text-red-500">*</span></p>
                            <input type="text" name="nazivPovezEdit" id="nazivPovezEdit" value="{{$povez->name}}" class="flex w-[90%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]" onkeydown="clearErrorsNazivPovezEdit()"/>
                            @error('nazivPovezEdit')
