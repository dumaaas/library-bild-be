                    ...
                    <div
                        ...
                        <table class="min-w-full shadow-lg" id="myTable">
                            ...
                            @foreach($izdavaci as $izdavac)
                                    ...
                                    <td class="px-4 py-4 text-sm leading-5 text-right whitespace-no-wrap">
                                        ...
                                        <div
                                            ...
                                            <div class="absolute right-[25px] w-56 mt-[7px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                                ...
                                                <div class="py-1">
                                                    <a href="{{route('editIzdavac', ['izdavac' => $izdavac->id])}}" tabindex="0"
                                                        class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                        role="menuitem">
                                                        <i class="fas fa-edit mr-[1px] ml-[5px] py-1"></i>
                                                        <span class="px-4 py-0">Izmijeni izdavača</span>
                                                    </a>
                                                    <a href="#" tabindex="0" id="{{$izdavac->id}}"
                                ...
                                <!--Modal-->
                                <div
                                    class="absolute z-20 top-0 left-0 flex items-center justify-center hidden w-full h-screen bg-black bg-opacity-10 izbrisi-modal_{{$izdavac->id}}" id="{{$izdavac->id}}">
                                    <!-- Modal -->
                                    <div class="w-[500px] bg-white rounded shadow-lg md:w-1/3">
                                        <!-- Modal Header -->
                                        <div class="flex items-center justify-between px-[30px] py-[20px] border-b">
                                            <h3>Da li ste sigurni da želite da izbrišete izdavača?</h3>
                                            <button class="text-black close ponisti focus:outline-none" id="{{$izdavac->id}}">
                                        ...
                                        <div class="flex items-center justify-center px-[30px] py-[20px] border-t w-100 text-white">
                                            <a href="{{route('izbrisiIzdavaca', ['izdavac' => $izdavac->id])}}"
                                            ...
                                            <a href="#" id="{{$izdavac->id}}" class="ponisti shadow-lg w-[150px] focus:outline-none text-sm py-2.5 px-5 transition duration-300 ease-in rounded-[5px] bg-[#F44336] hover:bg-[#F55549] text-center">
