...
<section class="w-screen h-screen pl-[80px] pb-2 text-gray-700">
                        ...
                        <div
                            ...
                            <div class="absolute right-0 w-56 mt-[7px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                ...
                                <div class="py-1">
                                    ...
                                    <a href="#" tabindex="0" id="{{$transakcija->book->id}}"
            ...
            <div class="flex flex-row height-detaljiIzdavanje scroll pb-[20px]">
                <div class="">
                    ...
                    <!--Modal-->
                    <div
                        class="absolute z-20 top-0 left-0 flex items-center justify-center hidden w-full h-screen bg-black bg-opacity-10 izbrisi-modal_{{$transakcija->book->id}}" id="{{$transakcija->book->id}}">
                        <!-- Modal -->
                        <div class="w-[500px] bg-white rounded shadow-lg md:w-1/3">
                            <!-- Modal Header -->
                            <div class="flex items-center justify-between px-[30px] py-[20px] border-b">
                                <h3>Da li ste sigurni da želite da izbrišete knjigu?</h3>
                                <button class="text-black close ponisti focus:outline-none" id="{{$transakcija->book->id}}">
                            ...
                            <div class="flex items-center justify-center px-[30px] py-[20px] border-t w-100 text-white">
                                <a href="{{route('izbrisiKnjigu', ['knjiga' => $transakcija->book])}}"
                                ...
                                <a href="#" id="{{$transakcija->book->id}}" class="ponisti shadow-lg w-[150px] focus:outline-none text-sm py-2.5 px-5 transition duration-300 ease-in rounded-[5px] bg-[#F44336] hover:bg-[#F55549] text-center">
