...
<section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
            ...
            <div class="heading">
                <div class="flex flex-row justify-between border-b-[1px] border-[#e4dfdf]">
                        ...
                        <div>
                            <nav class="w-full rounded">
                                <ol class="flex list-reset">
                                    ...
                                    <li>
                                        <a href="{{ route('ucenikProfile', ['ucenik' => $ucenik->id]) }}" class="text-[#2196f3] hover:text-blue-600">
                                            ID-{{$ucenik->id}}
                                        </a>
                                    </li>
                                </ol>
                    ...
                    <div class="pt-[24px] pr-[30px]">
                        ...
                        <a href="{{ route('editUcenik', ['ucenik' => $ucenik->id]) }}" class="hover:text-blue-600 inline ml-[20px] pr-[10px]">
            ...
            <div class="border-b-[1px] py-4 text-gray-500 border-[#e4dfdf] pl-[30px]">
                <a href="{{ route('ucenikProfile', ['ucenik' => $ucenik->id]) }}" class="inline active-book-nav">
                    Osnovni detalji
                </a>
                <a href="{{route('ucenikIzdate',['ucenik'=> $ucenik->id])}}" class="inline ml-[70px] hover:text-blue-800">
                    ...
                    <div class="flex flex-row">
                        <div class="mr-[30px]">
                            <div class="mt-[20px]">
                                ...
                                <p class="font-medium">{{$ucenik->name}}</p>
                            </div>
                            <div class="mt-[40px]">
                                <span class="text-gray-500">Tip korisnika</span>
                                <p class="font-medium">{{$ucenik->userType->name}}</p>
                            </div>
                            <div class="mt-[40px]">
                            ...
                            <div class="mt-[40px]">
                                ...
                                <a href="#" class="block font-medium text-[#2196f3]">{{$ucenik->email}}t</a>
                            </div>
                            <div class="mt-[40px]">
                                <span class="text-gray-500">Korisnicko ime</span>
                                <p class="font-medium">{{$ucenik->username}}</p>
                            </div>
                            <div class="mt-[40px]">
